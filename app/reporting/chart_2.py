...
def make_chart_html(
    ...
    *,
    ...
    slider_html = ""
    if strategy == "my_strategy3.py":
        PLAY_SPECS = {'st_factor': {'min': 1.0, 'max': 8.0, 'step': 0.05, 'default': 4.0, 'kind': 'float', 'digits': 4}, 'atr_mult': {'min': 1.0, 'max': 8.0, 'step': 0.05, 'default': 3.0, 'kind': 'float', 'digits': 3}, 'adx_no_trade_below': {'min': 5.0, 'max': 50.0, 'step': 0.5, 'default': 14.0, 'kind': 'float', 'digits': 2}, 'rev_cooldown_hrs': {'min': 0, 'max': 48, 'step': 1, 'default': 8, 'kind': 'int', 'digits': 0}, 'max_flips_per_day': {'min': 1, 'max': 20, 'step': 1, 'default': 6, 'kind': 'int', 'digits': 0}}
