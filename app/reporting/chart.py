...
<head>
  ...
  <script>
    ...
    document.addEventListener("DOMContentLoaded", () => {{
      ...
      if (mtBtnLong) mtBtnLong.addEventListener('click', function() {{ mtSendBridgeAction('LONG'); }});
      if (mtBtnShort) mtBtnShort.addEventListener('click', function() {{ mtSendBridgeAction('SHORT'); }});
      if (mtBtnClose) mtBtnClose.addEventListener('click', function() {{ mtSendBridgeAction('CLOSE'); }});
