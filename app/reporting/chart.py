...
def _build_trades_table_html(bt, bars=None, params=None) -> str:
    ...
    live_trade_html = """
    <div class="manual-trade-box" style="margin:12px 0;padding:12px;border:1px solid #2a3b5f;border-radius:10px;background:#07111d;">
      <div style="display:flex;justify-content:space-between;align-items:center;gap:10px;flex-wrap:wrap;">
        <div style="font-weight:700;color:#dbeafe;">Live Position (Bybit)</div>
        <div style="display:flex;gap:8px;align-items:center;flex-wrap:wrap;">
          <label style="font-size:12px;color:#cbd5e1;display:flex;gap:4px;align-items:center;">
            <input id="mt_live_auto" type="checkbox" checked /> Auto
          </label>
          <button id="mt_live_refresh" type="button" style="padding:6px 10px;border-radius:8px;border:1px solid #334155;background:#111827;color:#e5e7eb;cursor:pointer;">Refresh</button>
        </div>
      </div>
      <div id="mt_live_status" style="margin-top:8px;font-size:12px;color:#cbd5e1;">Waiting...</div>
      <div style="margin-top:8px;display:grid;grid-template-columns:repeat(auto-fit,minmax(140px,1fr));gap:8px;">
        <div><div style="font-size:11px;color:#94a3b8;">Side</div><div id="mt_lp_side" style="font-weight:600;color:#e2e8f0;">-</div></div>
        <div><div style="font-size:11px;color:#94a3b8;">Size</div><div id="mt_lp_size" style="font-weight:600;color:#e2e8f0;">-</div></div>
        <div><div style="font-size:11px;color:#94a3b8;">Entry</div><div id="mt_lp_entry" style="font-weight:600;color:#e2e8f0;">-</div></div>
        <div><div style="font-size:11px;color:#94a3b8;">Mark</div><div id="mt_lp_mark" style="font-weight:600;color:#e2e8f0;">-</div></div>
        <div><div style="font-size:11px;color:#94a3b8;">PnL</div><div id="mt_lp_pnl" style="font-weight:600;color:#e2e8f0;">-</div></div>
        <div><div style="font-size:11px;color:#94a3b8;">Lev</div><div id="mt_lp_lev" style="font-weight:600;color:#e2e8f0;">-</div></div>
        <div><div style="font-size:11px;color:#94a3b8;">Liq</div><div id="mt_lp_liq" style="font-weight:600;color:#e2e8f0;">-</div></div>
        <div><div style="font-size:11px;color:#94a3b8;">TP</div><div id="mt_lp_tp" style="font-weight:600;color:#e2e8f0;">-</div></div>
        <div><div style="font-size:11px;color:#94a3b8;">SL</div><div id="mt_lp_sl" style="font-weight:600;color:#e2e8f0;">-</div></div>
      </div>
    </div>
    """
