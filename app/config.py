...
class Settings:
    ...
    # Trading execution mode: testnet | demo | mainnet
    BYBIT_MODE: str = os.getenv("BYBIT_MODE", "testnet").strip().lower()
    BYBIT_DEMO_REST_URL: str = os.getenv("BYBIT_DEMO_REST_URL", "https://api-demo.bybit.com")
    BYBIT_DEMO_KEY: str = os.getenv("BYBIT_DEMO_KEY", os.getenv("BYBIT_KEY", ""))
    BYBIT_DEMO_SECRET: str = os.getenv("BYBIT_DEMO_SECRET", os.getenv("BYBIT_SECRET", ""))
