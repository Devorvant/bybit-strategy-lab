    ...
    <div class='card'>
      <form id='startForm'>
        <div class='row'>
          ...
          <div>
            <label><span class='lbl'>select_on<span class='tip' data-tip='Какая часть данных определяет «лучший» trial.&#10;train = выбираем по train (валидация только для отчёта).&#10;val = выбираем по val (сильнее защищает от переобучения).'>?</span></span></label>
