...
def make_chart_html(
    ...
    *,
    ...
    <div class="manual-trade-box" style="margin:12px 0;padding:10px;border:1px solid #2a3b5f;border-radius:10px;background:#0b1220;">
      ...
      <div style="margin-top:8px;display:grid;grid-template-columns:repeat(7,minmax(120px,1fr));gap:8px;">
    ...
    <div class="manual-trade-box" style="margin:12px 0;padding:10px;border:1px solid #2a3b5f;border-radius:10px;background:#0b1220;">
      <div style="display:flex;align-items:center;justify-content:space-between;gap:10px;flex-wrap:wrap;">
        ...
        <div style="display:flex;align-items:center;gap:8px;flex-wrap:wrap;">
          ...
          <button id="mt_live_close" type="button" style="padding:5px 10px;border-radius:8px;border:1px solid #f97316;background:#3b1d0a;color:#fed7aa;cursor:pointer;">Close 100%</button>
...
function mtRenderLivePosition(payload) {{
      ...
      async function mtRefreshLoopStatus() {{
        try {{
          ...
          mtSetAutoField('mt_auto_loop', running ? 'RUNNING' : 'stopped');
      ...
      async function mtStartAutoLoop() {{
        ...
        try {{
          ...
          mtSetAutoField('mt_auto_loop', loop.running ? 'RUNNING' : 'stopped');
