...
def make_chart_html(
    ...
    *,
    ...
    def _render_value_cell(k: str, v) -> str:
        ...
        if k in ("use_no_trade", "use_flip_limit", "trade_from_current_capital", "confirm_on_close"):
    ...
    if strategy == "my_strategy3.py":
        ...
        <div class="params-card" id="playCard">
          ...
          <div class="muted" style="margin-top:6px;">Обновление происходит при отпускании ползунка. Таблица сделок ниже сейчас не пересчитывается — только сам график.</div>
