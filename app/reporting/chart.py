    ...
    <div class=\"params-card\" style=\"margin-top:12px\">
      ...
      <div style=\"display:grid;grid-template-columns:1fr 1fr;gap:10px\">
        <div style=\"padding:10px;border:1px solid #334155;border-radius:10px;background:#0b1220\">
          ...
          <div style=\"font-size:12px;color:#94a3b8;margin-bottom:6px\">{html.escape(str(legacy_note or 'signal'))}</div>
          <div style=\"display:inline-block;padding:4px 10px;border-radius:999px;background:#1f2937;color:#fff;font-weight:700\">{html.escape(str(legacy_signal or '-'))}</div>
        </div>
        <div style=\"padding:10px;border:1px solid #334155;border-radius:10px;background:#0b1220\">
          <div class=\"muted\" style=\"font-size:12px;margin-bottom:6px\">Backtest core signal</div>
          <div style=\"font-size:12px;color:#94a3b8;margin-bottom:6px\">{html.escape(str(bt_note or 'signal'))}</div>
          <div style=\"display:inline-block;padding:4px 10px;border-radius:999px;background:#1f2937;color:#fff;font-weight:700\">{html.escape(str(bt_signal or '-'))}</div>
        </div>
      </div>
    </div>
    """
