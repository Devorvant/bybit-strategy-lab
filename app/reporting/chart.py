...
function mtSetLiveField(id, value) {{
      ...
      function mtSetupAccountAuto() {{
        ...
        if (mtAccountTimer) {{ clearInterval(mtAccountTimer); mtAccountTimer = null; }}
        mtRefreshAccountInfo();
        mtAccountTimer = setInterval(function() {{ mtRefreshAccountInfo(); }}, 30000);
      }}
...
function mtRenderLivePosition(payload) {{
      ...
      function mtSetupLiveAuto() {{
        ...
        function resetTimer() {{
          ...
          if (chk && chk.checked) {{
            mtLiveTimer = setInterval(function() {{ mtRefreshLivePosition(); }}, 10000);
          }}
        }}
