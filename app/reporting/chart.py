    ...
    *,
    ...
    <div class="manual-trade-box" style="margin:12px 0;padding:10px;border:1px solid #2a3b5f;border-radius:10px;background:#0b1220;">
      ...
      <div style="margin-top:8px;display:grid;grid-template-columns:repeat(6,minmax(120px,1fr));gap:8px;">
        ...
        <div style="padding:8px;border:1px solid #23324f;border-radius:8px;background:#0f172a;"><div style="font-size:11px;color:#94a3b8;">Bar ts</div><div id="mt_auto_bar" style="font-weight:700;color:#e2e8f0;">-</div></div>
...
function mtRenderLivePosition(payload) {{
      ...
      async function mtAutoCall(execute) {{
        ...
        const payload = {{ symbol: sym.replace(/\.P$/i, ''), tf: tfv, execute: !!execute, trade_params }};
        ...
        try {{
          ...
          if (execute) {{
            ...
            resp = await fetch('/trade/auto/preview?symbol=' + encodeURIComponent(payload.symbol) + '&tf=' + encodeURIComponent(payload.tf));
          }}
