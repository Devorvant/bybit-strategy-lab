        ...
        try:
            ...
            <div class="params-card">
              ...
              <div style="display:grid;grid-template-columns:1fr 1fr;gap:8px;">
                <div><div style="font-size:12px;color:#94a3b8;margin-bottom:6px;">Legacy signal</div>{_sig_badge(sig_legacy, selected=(signal_mode=='legacy'))}</div>
                <div><div style="font-size:12px;color:#94a3b8;margin-bottom:6px;">Backtest core signal</div>{_sig_badge(sig_bt, selected=(signal_mode=='backtest'))}</div>
              </div>
            </div>
            """
...
<body>
  <form id="chartForm" class="topbar" method="get" action="/chart">
    ...
    <select name="signal_mode" style="width:110px">{signal_mode_options}</select>
