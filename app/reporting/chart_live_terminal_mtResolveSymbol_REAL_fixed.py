...
function mtRenderLivePosition(payload) {{
        ...
        if (!wrap.has_position || !pos) {{
          ...
          mtSetLiveField('mt_lp_side', 'NONE');
        ...
        mtSetLiveField('mt_lp_size', mtFmtNum(pos.size));
        mtSetLiveField('mt_lp_entry', mtFmtNum(pos.avgPrice));
        mtSetLiveField('mt_lp_mark', mtFmtNum(pos.markPrice));
        mtSetLiveField('mt_lp_pnl', mtFmtNum(pos.unrealisedPnl));
        mtSetLiveField('mt_lp_lev', pos.leverage || '-');
